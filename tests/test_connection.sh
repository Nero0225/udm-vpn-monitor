...
EOF
	...
	original_perms=$(stat -c %a "$cache_file")
...
EOF
	...
	mock_ipsec_status 0 "new-connection-name: ESTABLISHED 1 hour ago, ${TEST_PEER_IP}...${TEST_LOCAL_IP}"
	add_mock_to_path
...
EOF
  ...
  test-conn: ESTABLISHED
  other-conn: ESTABLISHED"
	add_mock_to_path
...
EOF
	...
	mock_ipsec_status 0 "discovered-connection-name: ESTABLISHED 1 hour ago, ${TEST_PEER_IP}...${TEST_LOCAL_IP}"
	add_mock_to_path
